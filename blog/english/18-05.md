...
* kin /kɪn/ n.亲戚；家族；同族 adj. 同类的；有亲属关系的；性质类似 的
...
* abbreviate theword 'building' as 'bldg' 将'building'缩写作'bldg'

### 近义词

* abridge /ə'brɪdʒ/ vt. 删节；缩短；节略
* curtail /kɚ'tel/ vt. 缩减；剪短；剥夺…特权等
* cut back 削减；修剪；（美）倒叙；急忙返回
* syncopate /'sɪnkəpet/ vt. 切分；词中省略，缩写
* truncate /trʌŋ'ket/ adj. 截短的；被删节的 vt. 把…截短；缩短；使成平面

### 反义词

* extend /ɪk'stɛnd/ vt. 延伸；扩大；推广；伸出；给予；使竭尽全力；对…估价 vi. 延伸；扩大；伸展；使疏开
* protract /pro'trækt/ vt. 绘制；延长；伸展
* elongate /ɪ'lɔŋɡet/ vt. 拉长；使延长；使伸长 vi. 拉长；延长；伸长 adj. 伸长的；延长的
* lengthen /'lɛŋθən/ vt. 使延长；加长 vi. 延长；变长
...
> if an activity or situation is punctuated by particular things, it is interruptedby them at intervals

* punctuate /ˈpʌŋktʃuet/ vt. 不时打断；强调；加标点于 vi. 加标点
...
* sinistral /sɪ'nɪstrəl/ adj. 左的；左旋的；使用左手的 n. 左撇子
* dextrality /dek'stræləti/ n. 右旋；右边
